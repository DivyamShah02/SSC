...
class BunglowDetails(models.Model):
    bunglow_created_at = models.DateTimeField(default=timezone.now)
    bunglow_id = models.CharField(max_length=255, unique=True)
    bunglow_added_by = models.CharField(max_length=255, null=True, blank=True)
    group_name = models.CharField(max_length=255, null=True, blank=True)
    head_image = models.ImageField(upload_to='bunglow/', storage=S3Boto3Storage(), null=True, blank=True)
    sec_image_1 = models.ImageField(upload_to='bunglow/', storage=S3Boto3Storage(), null=True, blank=True)
    sec_image_2 = models.ImageField(upload_to='bunglow/', storage=S3Boto3Storage(), null=True, blank=True)
    sec_image_3 = models.ImageField(upload_to='bunglow/', storage=S3Boto3Storage(), null=True, blank=True)
    sec_image_4 = models.ImageField(upload_to='bunglow/', storage=S3Boto3Storage(), null=True, blank=True)
    ...
    land_zone = models.CharField(max_length=255, null=True, blank=True)

    plot_rate_per_sq_yd = models.CharField(max_length=100, default='', null=True, blank=True)
    construction_rate_per_sq_yd = models.CharField(max_length=100, default='', null=True, blank=True)
    sbu_on_plot = models.CharField(max_length=100, default='', null=True, blank=True)
    sbu_on_construction = models.CharField(max_length=100, default='', null=True, blank=True)
    ...
    age_of_bunglow_by_developer = models.TextField(max_length=15, default='', null=True, blank=True)
    age_of_bunglow_rera = models.TextField(max_length=15, default='', null=True, blank=True)
    ...
    open_space_area = models.CharField(max_length=255, null=True, blank=True)
    project_architect = models.CharField(max_length=255, null=True, blank=True)
    landscape_architect = models.CharField(max_length=255, null=True, blank=True)
...
class BunglowUnitDetails(models.Model):
    ...
    solar_available_on_roof_top = models.BooleanField(default=False)
    size_of_unit = models.CharField(max_length=100, null=True, blank=True)
    size_of_unit_min = models.CharField(max_length=100, null=True, blank=True)
    size_of_unit_max = models.CharField(max_length=100, null=True, blank=True)
    carpet_area_rera = models.CharField(max_length=100, null=True, blank=True)
    construction_size_sq_yd = models.CharField(max_length=100, null=True, blank=True)
    jodi_possible = models.BooleanField(default=False)
    ...
    basement_levels = models.CharField(max_length=255, default=0, null=True, blank=True)
...
class BunglowAmenities(models.Model):
    bunglow_id = models.CharField(max_length=255, unique=True)
